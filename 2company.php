...
<header class="header">
    <br>
    <h1 class="header__title">ONE DAY BABY CARE SERVICE </h1><br>
        ...
        <div class=" row">
            ...
            <!-- <div class=" col-sm-4" > -->
                ...
                ?>
                        ...
                        <img src="<?php echo 'bservice/Pictures/'. $row['file1']; ?>" alt="<?php echo 'Pictures/'. $row['file2'] ?>" height="200" width="200" /> 
                    <a href="mwplanA.php?nameid=<?php echo $row['id']; ?>">    <?php  echo '<h2>'.$row['name'].'</h2>'; ?></a>
                        </div>
