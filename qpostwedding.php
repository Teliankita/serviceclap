...
$sql="INSERT INTO postwedding (drop1,drop2,drop3,drop4,drop5,date,phone) VALUES ('$drop1','$drop2','$drop3','$drop4','$drop5','$date',$phone)";
...
<body>
    <center>
        <h1>Best Post Wedding Photoshoot Post Wedding Photography in Bangalore</h1>
    </center>
    <br>
    <br>
    <br>
    ...
    <div class="container">
        <div class="boxed">
            ...
            <form action="postwedding.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-7">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="form-group">
                            <label for="team" style="color:black;">
                                <h3>What all services do you require in your post-wedding shoot?</h3>
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-3">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="form-group">
                            <label for="team" style="color:black;">
                                <h3>When would you like to get your post - wedding shoot done?</h3>
                            </label>
                        </div>
                    </div>
