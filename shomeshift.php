        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh2.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                        </p>
                        <a href="3shomeshift.php" class="btn btn-primary">Click here</a>
                    </div>
                    <a class="fancybox" rel="ligthbox" href="img/sh2.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh6.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/sh6.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh3.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/sh3.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh4.jpg" alt=""  style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/sh4.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh5.jpg" alt=""  style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/sh5.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh10.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/sh10.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/sh9.jpg" alt=""  style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Shift</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/sh9.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 img_space ">
                    ...
                    <img class="img-responsive" src=" img/sh3.jpg"
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 img_space">
                    <!-- Trigger the modal with a button -->
                    <img class="img-responsive" src=" img/sh7.jpg"
                        data-toggle="modal" data-target="#myModal1">
                    <!-- Modal -->
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 img_space">
                    <!-- Trigger the modal with a button -->
                    <img class="img-responsive" src=" img/sh1.jpg"
            ...
            <div class="modal fade" id="myModal1" role="dialog">
                <div class="modal-dialog">
                    ...
                    <!-- Modal content-->
                    <a href="#" class="close" data-dismiss="modal"> </a>
                    <img class="img-responsive img-thumbnail" src="img/sh7.jpg">
            ...
            <div class="modal fade" id="myModal2" role="dialog">
                <div class="modal-dialog">
                    ...
                    <!-- Modal content-->
                    <a href="#" class="close" data-dismiss="modal"> </a>
                    <img class="img-responsive img-thumbnail" src="img/sh1.jpg">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="img/h6.jpg" width="75" height="75" alt="image">
                                </a>
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="img/h7.jpg" width="75" height="75" alt="image">
                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/sh10.jpg" class="img-responsive" alt="Image" width="140" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/sh7.jpg" class="img-responsive" alt="Image" width="120" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/h10.jpg" class="img-responsive" alt="Image" width="130" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/h11.jpg" class="img-responsive" alt="Image" width="130" height="75">
                                    </a>
                                </div>
                            </div>
                        </div>
