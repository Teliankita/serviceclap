...
$sql="INSERT INTO aphotocomp (pname,image) VALUES ('$pname','$file')";
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <form id="addsponser" action="aphotocomp.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="name" style="font-size:15px;color:black;">Enter Photographer Name</label>
                        <input type="text" class="form-control" id="pname" name="pname" placeholder="enter location name">
                    </div>
                    <div class="form-group">
