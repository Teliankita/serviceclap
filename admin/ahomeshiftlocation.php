...
$sql="INSERT INTO ahomeshiftlocation (lname) VALUES ('$lname')";
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <form id="addsponser" action="ahomeshiftlocation.php" method="POST" enctype="multipart/form-data">
