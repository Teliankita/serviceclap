...
$sql="INSERT INTO plques (guest,budget) VALUES ('$guest','$budget')";
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <form id="addsponser" action="plque.php" method="POST" enctype="multipart/form-data">
                    <div class="form-group">
                        <label for="name" style="font-size:15px;color:black;">Enter How many Guests</label>
                        <input type="text" class="form-control" id="guest" name="guest" placeholder="enter location name">
                    </div>
                    <div class="form-group">
                        <label for="name" style="font-size:15px;color:black;">Enter Budget</label>
                        <input type="text" class="form-control" id="budget" name="budget" placeholder="enter location name">
                    </div>
