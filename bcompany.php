...
if(isset($_REQUEST["delid"]))
{
    ...
    $sql="DELETE FROM 1image where id='$delid'";
...
<header class="header" >
    <br>
    <center>
    <h1 class="header__title">ONE DAY BABY CARE SERVICE </h1><br></center>
    ...
    <!-- <a href="http://praliedutzel.com/a-guide-to-hero-images/" target="_blank"style="width:200px;"  class="btn btn-default" ><h4>Create</h4></a> -->
        ...
        <?php echo "<a href='bcompany.php?delid=".$row['id']."'>Delete</a>";?>
        <?php echo "<a href='bview.php?name=".$row['name']."'>View</a>";?>
          </div>
          <br>  
                <?php } ?>
                <div>
                ...
                <a href="bindex.php"><button type="submit" class="btn btn-default" style="width: 160px; height: 48px; float:left;   background-color: #212121;    color: #fff;">Back</button></a>
