...
$query=mysqli_query($con,"SELECT * FROM ababylocation");
...
<?php } ?>
     ...
     <a href="3sbaby.php"><button class="btn btn-success" style="width: 90px; height: 48px; float:left; background-color: #212121; color: #fff;">Back</button></a>
