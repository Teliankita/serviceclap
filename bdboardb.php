...
<div class="container">
    <h3 style="padding-top: 30px; text-align: center; text-decoration: underline; font-weight: bolder; color: #2e7af4">Admin Dashboard for ONE DAY BABY CARE SERVICE in Banglore, Hassan & Mysure   </h3>
    <div class="row">
    <div class="col-md-1"></div>
        <div class="col-md-10">
                ...
                <table class="table table-striped table-hover table-responsive table-bordered">
                        <tr class="success">
                       <th>ONE DAY BABY CARE SERVICE</th>
                            <th>Event Type</th>
                            <th>Time</th>
                            <th>Month</th>
                            <th>Budget</th>
...
$query=mysqli_query($con,"SELECT * FROM babycare");
