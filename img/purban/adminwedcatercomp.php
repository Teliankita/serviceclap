...
$sql="INSERT INTO aweddingcatercomp (cname,image) VALUES ('$cname','$file')";
...
<body>
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-3">
                <form id="addsponser" action="adminwedcatercomp.php" method="POST" enctype="multipart/form-data">
