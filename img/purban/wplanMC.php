...
$sql="INSERT INTO wplan (drop5,drop1,drop2,date,phone) VALUES ('$drop5','$drop1','$drop2','$date',$phone)";
...
<head>
    ...
    <style>
        body {
            padding: 50px;
            background-image:url("weding1.jpg");
        }
...
<body class="bg1">
    ...
    <div class="container">
        <div class="boxed">
            ...
            <form action="wplanMC.php" method="POST" enctype="multipart/form-data" onsubmit="return myfun()">
            <div class="row">
                    <div class="col-sm-7">
