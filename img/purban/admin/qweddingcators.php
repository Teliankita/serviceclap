...
$sql="INSERT INTO weddingcators (drop1,drop2,drop3,drop4,date,phone) VALUES ('$drop1','$drop2','$drop3','$drop4','$date',$phone)";
...
<body>
    <center>
        <h1>Best Wedding Caterer in Bangalore</h1>
    </center>
    <br>
    <br>
    <br>
    ...
    <div class="container">
        <div class="boxed">
            ...
            <form action="weddingcators.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-7">
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="form-group">
                            <label for="team" style="color:black;">
                                <h3>Expected number of guests:</h3>
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-4" >
                ...
                <div class="row">
                    <div class="col-sm-7">
                        <div class="form-group">
                            <label for="team" style="color:black;">
                                <h3>Approximate budget for the caterer:</h3>
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-4" >
