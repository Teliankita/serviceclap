...
$sql="INSERT INTO meplan (drop5,drop1,drop2,date,phone) VALUES ('$drop5','$drop1','$drop2','$date',$phone)";
...
<body>
    ...
    <div class="container">
        <div class="boxed">
            ...
            <form action="engagement111.php" method="POST" enctype="multipart/form-data" onsubmit="return myfun()">
                <div class="row">
                    <div class="col-sm-7">
