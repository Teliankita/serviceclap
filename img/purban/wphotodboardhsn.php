...
<a href="wphotodboardm.php">Wedding Photographers in Manglore</a>
<a href="wphotodboardh.php">Wedding Photographers in Hassan</a>
...
$query=mysqli_query($con,"SELECT * FROM wphotohsn");
