...
<div class="boxed">
       ...
       <nav class="navbar navbar-default navbar-fixed-top" style="background: #000000;color:#fff;">
        ...
        <div class="row">
            ...
            <br>
            <br>
                <a href="1homeshiftlocation.php">
                    <img class="" src="img/hs11.jpg" width="100%" height="400px">
                </a>
            </div>

            <div class="col-sm-5">
                <h3>
                    Traditionally, the bride's parents are the hosts of the wedding, even for very formal affairs.
                    However, including the names of both sets of parents as hosts is a gracious option no matter
                    who foots the bill. Also, more and more couples these days are hosting their own weddings, or
                    do so together with their parents.

                    If it's a collaborative affair hosted and paid for by the bride, groom and both sets of
                    parents, you can also use "Together with their parents, Emma and Jax request the pleasure of
                    your company ..."
                </h3>
            </div>

        </div>
        <a href="1homeshiftlocation.php"><button class="btn btn-success" style="background: #000000;">Next</button></a>
