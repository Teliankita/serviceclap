...
<div class="container">
    <h3 style="padding-top: 30px; text-align: center; text-decoration: underline; font-weight: bolder; color: #2e7af4">Admin Dashboard for Best Wedding Planer in Banglore, Hassan & Mysure    </h3>
    <div class="row">
...
$query=mysqli_query($con,"SELECT * FROM 	weddingplanner");
