        ...
        <div class="container-fluid">
            <div class="row">
                ...
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c4.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                        </p>
                        <a href="3shometution.php" class="btn btn-primary">Click here</a>
                    </div>
                    <a class="fancybox" rel="ligthbox" href="img/c4.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c5.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c5.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c6.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c6.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c7.jpg" alt=""  style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c7.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c8.jpg" alt=""  style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c8.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c1.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c1.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c2.jpg" alt=""  style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c2.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
                <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text">
                    <img src="img/c3.jpg" alt="" style="height:200px;">
                    <div class="portfolio_images_overlay text-center">
                        <h6 class="clrd-font">Tutors</h6>
                        <p class="clrd-font product_price">
                            <!-- <i class="fa fa-usd clrd-font" aria-hidden="true"></i> 12 -->
                    ...
                    <a class="fancybox" rel="ligthbox" href="img/c3.jpg">
                        <div class="zoom"></div>
                    </a>
                </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4 col-lg-4 col-sm-6 img_space ">
                    ...
                    <img class="img-responsive" src=" img/c9.jpg"
                ...
                <div class="col-md-4 col-lg-4 col-sm-6 img_space">
                    <!-- Trigger the modal with a button -->
                    <img class="img-responsive" src=" img/c12.jpg"
                        data-toggle="modal" data-target="#myModal1">
                    <!-- Modal -->
                </div>
                <div class="col-md-4 col-lg-4 col-sm-6 img_space">
                    <!-- Trigger the modal with a button -->
                    <img class="img-responsive" src=" img/c10.jpg"
            ...
            <div class="modal fade" id="myModal1" role="dialog">
                <div class="modal-dialog">
                    ...
                    <!-- Modal content-->
                    <a href="#" class="close" data-dismiss="modal"> </a>
                    <img class="img-responsive img-thumbnail" src="img/c12.jpg">
            ...
            <div class="modal fade" id="myModal2" role="dialog">
                <div class="modal-dialog">
                    ...
                    <!-- Modal content-->
                    <a href="#" class="close" data-dismiss="modal"> </a>
                    <img class="img-responsive img-thumbnail" src="img/c10.jpg">
                        ...
                        <div class="footer-widget">
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="img/10.jpg" width="75" height="75" alt="image">
                                </a>
                            ...
                            <div class="media">
                                <a class="pull-left" href="#">
                                    <img class="media-object" src="img/b8.jpg" width="75" height="75" alt="image">
                                </a>
                                <div class="media-body">
                                    <h5 class="media-heading">
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/c6.jpg" class="img-responsive" alt="Image" width="100" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/c2.jpg" class="img-responsive" alt="Image" width="120" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/c5.jpg" class="img-responsive" alt="Image" width="130" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/c9.jpg" class="img-responsive" alt="Image" width="130" height="75">
                                    </a>
                                </div>
                            </div>
                        </div>
