...
<div class="boxed">
       ...
       <nav class="navbar navbar-default navbar-fixed-top" style="background: #000000;color:#fff;">
        ...
        <div class="row">
            ...
            <div class="col-sm-5">
                <a href="1wplanlocation.php">
                    <img class="" src="img/w18.jpg" width="100%" height="400px">
                </a>
            </div>
        ...
        <a href="1wplanlocation.php"><button class="btn btn-success" style="background: #000000;">Next</button></a>
