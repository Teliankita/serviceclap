        ...
        <div class="container">
            ...
            <div id="navbar" class="navbar-collapse collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="dropdown">
                        <a href="subpage1.php" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">Services
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li>
                                <a href="#.php">One Day Baby Care</a>
                            </li>
                            <li>
                                <a href="#.php">MAKEUP</a>
                            </li>
                                ...
                                <div class="services__item box">
                                    <div class="services-item__body">
                                        ...
                                        <div class="services-item__content">
                                            ...
                                            <a class="services-item__link" href="#">Learn more
                            ...
                            <div class="col-sm-3">
                                <div class="services__item box">
                                    <div class="services-item__body">
                                        ...
                                        <div class="services-item__content">
                                            <p class="services-item__caption">Home Service</p>
                                            <a class="services-item__link" href="#">Learn more
                                                <i class="fa fa-angle-right"></i>
                                            </a>
                                        </div>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <div class="col-md-3 col-sm-4 col-xs-12 single_portfolio_text" >
                        <img src="img/w19.jpg" alt="" />
                        <div class="portfolio_images_overlay text-center">
                            <h6 class="clrd-font">Itali</h6>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-4 col-lg-4 col-sm-6 img_space ">
                        ...
                        <img class="img-responsive" src=" img/w4.jpg" data-toggle="modal" data-target="#myModal">
                        <!-- Modal -->
                    ...
                    <div class="col-md-4 col-lg-4 col-sm-6 img_space">
                        <!-- Trigger the modal with a button -->
                        <img class="img-responsive" src=" img/w7.jpg" data-toggle="modal" data-target="#myModal1">
                        <!-- Modal -->
                    </div>
                    <div class="col-md-4 col-lg-4 col-sm-6 img_space">
                        <!-- Trigger the modal with a button -->
                        <img class="img-responsive" src=" img/w1.jpg" data-toggle="modal" data-target="#myModal2">
                        <!-- Modal -->
                    </div>
                            ...
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/w15.jpg" class="img-responsive" alt="Image" width="140" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/w18.jpg" class="img-responsive" alt="Image" width="140" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/w16.jpg" class="img-responsive" alt="Image"  width="160" height="75">
                                    </a>
                                </div>
                                <div class="col-lg-6 col-md-6 col-sm-3 col-xs-6">
                                    <a href="#" class="thumbnail">
                                        <img src="img/w6.jpg" class="img-responsive" alt="Image" width="130" height="75">
                                    </a>
                                </div>
                            </div>
                        </div>
