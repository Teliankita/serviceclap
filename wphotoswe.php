...
$sql="INSERT INTO wphoto (drop8,date,drop2,drop3,drop4,drop5,phone) VALUES ('$drop8','$date','$drop2','$drop3','$drop4','$drop5','$phone')";
...
<body class="bg1">
    <center>
        <h1>Swetha Wedding Photographer</h1>
    </center>
    <br>
    <br>
    <br>
    ...
    <div class="container">
        <div class="boxed">
            ...
            <form action="wphotoswe.php" method="POST" enctype="multipart/form-data" onsubmit="return myfun()">
            <br>
            <br>
            <div class="row">
                    <div class="col-sm-7">
