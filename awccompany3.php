...
<header class="header">
    <br>
    <h1 class="header__title">Best Wedding Planner in Banglore</h1>
        ...
        <div class=" row">
            ...
            <div class=" col-sm-4" >
                <div class="col-xs-12 img-outer" style="margin: 20px 0;">
                    ...
                    <?php 
                $sql="SELECT * FROM awcni WHERE id=2";
            ...
            <div class=" col-lg-4 col-mid-4 col-sm-12" style="padding:25px;">
                <div class="col-xs-12 img-outer" style="margin: 20px 0;">
                    <div class="hovereffect">
                    <?php 
                $sql="SELECT * FROM awcni WHERE id=6";
                $res=mysqli_query($con,$sql);
                while($row=mysqli_fetch_assoc($res)){
                    ?>
                        <div class="z-text">
            ...
            <div class=" col-sm-4">
                <div class="col-xs-12 img-outer" style="margin: 20px 0;">
                    <div class="hovereffect">
                    <?php 
                $sql="SELECT * FROM awcni WHERE id=8";
                $res=mysqli_query($con,$sql);
                while($row=mysqli_fetch_assoc($res)){
                    ?>
                        <div class="z-text">
