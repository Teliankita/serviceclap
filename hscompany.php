...
if(isset($_REQUEST["delid"]))
{
    ...
    $sql="DELETE FROM 3image where id='$delid'";
...
<header class="header" >
    <br>
    <center>
    <h1 class="header__title">PACKER & MOVERS </h1><br></center>
    ...
    <!-- <a href="http://praliedutzel.com/a-guide-to-hero-images/" target="_blank"style="width:200px;"  class="btn btn-default" ><h4>Create</h4></a> -->
        ...
        <?php echo "<a href='hscompany.php?delid=".$row['id']."'>Delete</a>";?>
        <?php echo "<a href='hsview.php?name=".$row['name']."'>View</a>";?>
          ...
          <br>  
                ...
                <a href="hsindex.php"><button type="submit" class="btn btn-default" style="width: 160px; height: 48px; float:left;   background-color: #212121;    color: #fff;">Back</button></a>
