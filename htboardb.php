                    ...
                    <ul class="nav navbar-nav">
                        <li class="active">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li>
                                    <a href="bboardb.php">One Day Baby Care</a>
                                </li>
                                <!-- <li>
...
<div class="container">
    <h3 style="padding-top: 30px; text-align: center; text-decoration: underline; font-weight: bolder; color: #2e7af4">Admin Dashboard for HOME TUTORS SERVICE in Banglore, Hassan & Mysure    </h3>
    <div class="row">
...
$query=mysqli_query($con,"SELECT * FROM hometutors");
