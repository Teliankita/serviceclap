...
<header class="header">
    <br>
    <h1 class="header__title">Best Wedding Planner in Banglore</h1><br>
        ...
        <div class=" row">
            ...
            <!-- <div class=" col-sm-4" > -->
                ...
                ?>
                        ...
                        <img src="<?php echo 'wservice/Pictures/'. $row['file1']; ?>" alt="<?php echo 'Pictures/'. $row['file2'] ?>" height="200" width="200" /> 
