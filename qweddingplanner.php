...
$sql="INSERT INTO weddingplanner (drop1,drop2,date,drop3,drop4,phone) VALUES ('$drop1','$drop2','$date','$drop3','$drop4',$phone)";
...
<body>
    <center>
        <h1>Best Wedding Planners in Bangalore</h1>
    </center>
    <br>
    <br>
    <br>
    ...
    <div class="container">
        <div class="boxed">
            ...
            <form action="weddingplanner.php" method="POST" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-sm-7">
                        <div class="form-group">
                            <label for="team" style="color:black;">
                                <h3>Where are you planning to have your wedding?</h3>
                            </label>
                        </div>
                    </div>
                    <div class="col-sm-3">
                        <br>
                        <select name="drop1" id="drop1" id="1">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-3">
                    <br>
                        <select name="drop2" id="drop2" id="1">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" >
                    <br>
                        <input id="date" type="date" name="date" id="1" required="">
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-4" ><br>
                        <select name="drop3" id="drop3" id="1"  style="width:170px" >
                ...
                <div class="row">
                    ...
                    <select name="drop4" id="drop4" id="1"  style="width:170px" >
                            <option value="Bangalore">Bangalore</option>
                            <option value="Outstation wedding: I will cover artist's travel expenses">Outstation wedding: I will cover artist's travel expenses</option>
                        </select>
                    </div>
                    </div>
                    <hr>
